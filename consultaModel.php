...
function createConsulta($idveterinario, $idanimal, $data, $idstatus) {
    ...
    VALUES ('$idveterinario', '$idanimal', '$data', '$idstatus', now())";
...
function getConsultas() {
    ...
    a.nome AS nome_cachorro, cl.nome AS cliente_nome, cl.sobrenome AS cliente_sobrenome, c.data, s.nome_status
    FROM consulta c
...
function updateConsulta($idconsulta, $idveterinario, $idanimal, $data, $idstatus) {
    global $connect;
